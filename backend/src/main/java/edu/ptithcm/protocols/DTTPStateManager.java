...
public class DTTPStateManager {
    ...
    private final Map<String, Map<String, Object>> userMeta =
    ...
    public boolean isOnline(String username) {
        return userToConn.containsKey(username);
    }

    public DTTP getConn(String username) {
        return userToConn.get(username);
    }

    public String getUsername(DTTP conn) {
        return connToUser.get(conn);
    }

    public Map<String, Object> getUserMeta(String username) {
        return userMeta.get(username);
    }

    public int count() {
        return userToConn.size();
    }
    ...
    public void sendTo(
        ...
        try {
            ...
            System.err.println(
                "[ERROR] sendTo(" + username + "): " + e.getMessage()
            );
        }
    }
    ...
    public void broadcast(Map<String, Object> data, String message) {
        userToConn.forEach((username, conn) -> {
            try {
                ...
                System.err.println(
                    "[ERROR] broadcast → " + username + ": " + e.getMessage()
                );
            }
        });
    }
