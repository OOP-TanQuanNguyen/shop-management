...
public class InvoiceController {
    ...
    public ResponseDTO<InvoiceInfo> deleteInvoice(InvoiceRequestDTO req) {
        return SafeExecutor.run(() ->
            service.deleteInvoice(req.getInvoiceId())
        );
    }
    ...
    public ResponseDTO<InvoiceInfo> getInvoiceById(InvoiceRequestDTO req) {
        return SafeExecutor.run(() ->
            service.getInvoiceById(req.getInvoiceId())
        );
    }
    ...
    public ResponseDTO<List<InvoiceInfo>> getInvoiceByCustomer(
        ...
        return SafeExecutor.run(() ->
            service.getInvoiceByCustomer(req.getCustomerId())
        );
    }

    // ---------- GET BY BRANCH ----------
    public ResponseDTO<List<InvoiceInfo>> getInvoiceByBranch(
        InvoiceRequestDTO req
    ) {
        return SafeExecutor.run(() ->
            service.getInvoiceByBranch(req.getBranchId())
        );
    }
    ...
    public ResponseDTO<List<InvoiceInfo>> getInvoiceByEmployee(
        ...
        System.out.println("controller EmployeeId : " + req.getEmployeeId());
        return SafeExecutor.run(() ->
            service.getInvoiceByEmployee(req.getEmployeeId())
        );
    }
    ...
    public ResponseDTO<InvoiceInfo> confirmInvoice(InvoiceRequestDTO req) {
        return SafeExecutor.run(() ->
            service.confirmInvoice(req.getInvoiceId())
        );
    }
    ...
    public ResponseDTO<InvoiceInfo> cancelInvoice(InvoiceRequestDTO req) {
        return SafeExecutor.run(() ->
            service.cancelInvoice(req.getInvoiceId())
        );
    }
}
